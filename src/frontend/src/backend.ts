...
import type { CategoryId as _CategoryId, CategoryPublic as _CategoryPublic, Error as _Error, ExternalBlob as _ExternalBlob, FontChoice as _FontChoice, ItemId as _ItemId, MenuItemPublic as _MenuItemPublic, Principal as _Principal, Result as _Result, SubCategoryId as _SubCategoryId, SubCategoryPublic as _SubCategoryPublic, ThemePublic as _ThemePublic, Timestamp as _Timestamp, TrainingStepEdit as _TrainingStepEdit, TrainingStepInput as _TrainingStepInput, TrainingStepPublic as _TrainingStepPublic, UserProfilePublic as _UserProfilePublic, UserRole as _UserRole, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createCategory(arg0: string, arg1: ExternalBlob): Promise<CategoryId> {
        if (this.processError) {
            try {
                const result = await this.actor.createCategory(arg0, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createSubCategory(arg0: CategoryId, arg1: string, arg2: ExternalBlob): Promise<SubCategoryPublic> {
        if (this.processError) {
            try {
                ...
                return from_candid_SubCategoryPublic_n20(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async createTrainingStep(arg0: ItemId, arg1: TrainingStepInput): Promise<TrainingStepPublic> {
        if (this.processError) {
            try {
                const result = await this.actor.createTrainingStep(arg0, await to_candid_TrainingStepInput_n23(this._uploadFile, this._downloadFile, arg1));
                return from_candid_TrainingStepPublic_n25(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async editTrainingStep(arg0: bigint, arg1: TrainingStepEdit): Promise<TrainingStepPublic> {
        if (this.processError) {
            try {
                const result = await this.actor.editTrainingStep(arg0, await to_candid_TrainingStepEdit_n28(this._uploadFile, this._downloadFile, arg1));
                return from_candid_TrainingStepPublic_n25(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTheme(): Promise<ThemePublic> {
        if (this.processError) {
            try {
                ...
                return from_candid_ThemePublic_n34(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateCategory(arg0: CategoryId, arg1: string, arg2: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCategory(arg0, arg1, await to_candid_ExternalBlob_n18(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateLogo(arg0: ExternalBlob | null): Promise<ThemePublic> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLogo(await to_candid_opt_n46(this._uploadFile, this._downloadFile, arg0));
                return from_candid_ThemePublic_n34(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTheme(arg0: string | null, arg1: string | null, arg2: FontChoice | null): Promise<ThemePublic> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTheme(to_candid_opt_n47(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n47(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n48(this._uploadFile, this._downloadFile, arg2));
                return from_candid_ThemePublic_n34(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_CategoryPublic_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CategoryPublic): Promise<CategoryPublic> {
...
function from_candid_FontChoice_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FontChoice): FontChoice {
    return from_candid_variant_n37(_uploadFile, _downloadFile, value);
}
async function from_candid_MenuItemPublic_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MenuItemPublic): Promise<MenuItemPublic> {
...
async function from_candid_SubCategoryPublic_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SubCategoryPublic): Promise<SubCategoryPublic> {
    return await from_candid_record_n21(_uploadFile, _downloadFile, value);
}
async function from_candid_ThemePublic_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ThemePublic): Promise<ThemePublic> {
    return await from_candid_record_n35(_uploadFile, _downloadFile, value);
}
async function from_candid_TrainingStepPublic_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TrainingStepPublic): Promise<TrainingStepPublic> {
...
async function from_candid_opt_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MenuItemPublic]): Promise<MenuItemPublic | null> {
    return value.length === 0 ? null : await from_candid_MenuItemPublic_n31(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SubCategoryId]): SubCategoryId | null {
    return value.length === 0 ? null : value[0];
}
async function from_candid_opt_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_TrainingStepPublic]): Promise<TrainingStepPublic | null> {
    return value.length === 0 ? null : await from_candid_TrainingStepPublic_n25(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        coverPhoto: await from_candid_ExternalBlob_n22(_uploadFile, _downloadFile, value.coverPhoto)
    };
}
...
async function from_candid_record_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        subCategoryId: record_opt_to_undefined(from_candid_opt_n33(_uploadFile, _downloadFile, value.subCategoryId)),
        itemPhoto: await from_candid_ExternalBlob_n22(_uploadFile, _downloadFile, value.itemPhoto),
...
async function from_candid_record_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        font: from_candid_FontChoice_n36(_uploadFile, _downloadFile, value.font),
...
async function from_candid_vec_n39(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CategoryPublic>): Promise<Array<CategoryPublic>> {
    return await Promise.all(value.map(async (x)=>await from_candid_CategoryPublic_n40(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n42(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MenuItemPublic>): Promise<Array<MenuItemPublic>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MenuItemPublic_n31(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n43(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SubCategoryPublic>): Promise<Array<SubCategoryPublic>> {
    return await Promise.all(value.map(async (x)=>await from_candid_SubCategoryPublic_n20(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n44(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TrainingStepPublic>): Promise<Array<TrainingStepPublic>> {
    return await Promise.all(value.map(async (x)=>await from_candid_TrainingStepPublic_n25(_uploadFile, _downloadFile, x)));
}
function from_candid_vec_n45(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_UserProfilePublic>): Array<UserProfilePublic> {
...
function to_candid_FontChoice_n49(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FontChoice): _FontChoice {
    return to_candid_variant_n50(_uploadFile, _downloadFile, value);
}
async function to_candid_TrainingStepEdit_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TrainingStepEdit): Promise<_TrainingStepEdit> {
    return await to_candid_record_n24(_uploadFile, _downloadFile, value);
}
async function to_candid_TrainingStepInput_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TrainingStepInput): Promise<_TrainingStepInput> {
    return await to_candid_record_n24(_uploadFile, _downloadFile, value);
}
...
function to_candid_opt_n48(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FontChoice | null): [] | [_FontChoice] {
    return value === null ? candid_none() : candid_some(to_candid_FontChoice_n49(_uploadFile, _downloadFile, value));
}
...
function to_candid_variant_n50(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FontChoice): {
    sansSerif: null;
} | {
    monospace: null;
} | {
