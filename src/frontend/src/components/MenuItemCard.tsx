...
// Square-ish dish photo with a dark card body holding the Oswald dish name
// and a short description preview. Whole card links to the recipe card view.
    ...
    >
      <article className="flex h-full flex-col overflow-hidden rounded-xl border border-border bg-card shadow-card transition-smooth group-hover:-translate-y-1 group-hover:border-primary/50 group-hover:shadow-elevated group-focus-visible:ring-2 group-focus-visible:ring-ring group-focus-visible:ring-offset-2 group-focus-visible:ring-offset-background">
        ...
        <div className="flex flex-1 flex-col gap-1.5 p-4">
          ...
          <span className="mt-auto pt-2 text-xs font-semibold uppercase tracking-wider text-accent">
            View recipe
          </span>
        </div>
      </article>
